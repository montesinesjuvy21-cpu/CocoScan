...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the Cocosan severity classifier")
    parser.add_argument("--data_dir", required=True, help="Path to severity dataset directory")
    parser.add_argument("--output_path", required=True, help="Path to save trained severity model")
...
def main():
    ...
    print(f"Saved severity classifier ({args.model}) to {args.output_path}")
